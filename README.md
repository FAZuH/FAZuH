...
- [![Ansible](https://img.shields.io/badge/Ansible-EE0000?style=flat-square&logo=ansible&logoColor=white)](https://www.ansible.com/): Configuration management and node provisioning
...
- [![Consul](https://img.shields.io/badge/Consul-F24C53?style=flat-square&logo=consul&logoColor=white)](https://www.consul.io/): Store service configs for auto-discovery and routing with [lab-ops](https://github.com/FAZuH/lab-ops)
...
- [![Terraform](https://img.shields.io/badge/Terraform-7B42BC?style=flat-square&logo=terraform&logoColor=white)](https://www.terraform.io/): Infrastructure as Code (IaC) for provisioning and managing cloud infrastructure and VM instances
